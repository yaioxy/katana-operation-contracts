...
import { getV2PoolReserves, WETH, AXS, USDC, PIXEL } from './mainnetForkHelpers'
...
export const pool_AXS_WETH = makePool(AXS, WETH, liquidity)
export const pool_AXS_USDC = makePool(USDC, AXS, liquidity)
export const pool_USDC_WETH = makePool(USDC, WETH, liquidity)
export const pool_USDC_PIXEL = makePool(USDC, PIXEL, liquidity)
export const pool_WETH_PIXEL = makePool(PIXEL, WETH, liquidity)
